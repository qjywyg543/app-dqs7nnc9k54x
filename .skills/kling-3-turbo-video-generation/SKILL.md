...
- 文生创建任务：`POST https://app-dqs7nnc9k54x-api-zYm4DV8yrj8L-gateway.appmiaoda.com/text-to-video/kling-3.0-turbo`
- 图生创建任务：`POST https://app-dqs7nnc9k54x-api-eLMlzO5Veyw9-gateway.appmiaoda.com/image-to-video/kling-3.0-turbo`
- 统一查询任务：`GET https://app-dqs7nnc9k54x-api-baBwmdOB6lG9-gateway.appmiaoda.com/tasks`
...
async function queryTurboVideoTask(
  ...
  const response = await fetch(
    `https://app-dqs7nnc9k54x-api-baBwmdOB6lG9-gateway.appmiaoda.com/tasks?${query}`,
    {
      method: "GET",
      headers: {
...
const createResp = await fetch(
  "https://app-dqs7nnc9k54x-api-zYm4DV8yrj8L-gateway.appmiaoda.com/text-to-video/kling-3.0-turbo",
  {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
...
```typescript
const createResp = await fetch(
  "https://app-dqs7nnc9k54x-api-eLMlzO5Veyw9-gateway.appmiaoda.com/image-to-video/kling-3.0-turbo",
  {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
