...
| Endpoint | `GET https://app-dqs7nnc9k54x-api-baBwmdOB6lG9-gateway.appmiaoda.com/tasks` |
| Auth 模式 | `platform_managed`（`traefik: true`） |
| Auth Header | `X-Gateway-Authorization: Bearer ${INTEGRATIONS_API_KEY}` |
| third_part_domain | `app-dqs7nnc9k54x-api-zYm4DV8yrj8L-gateway.appmiaoda.com` |
...
const TASKS_ENDPOINT =
  "https://app-dqs7nnc9k54x-api-baBwmdOB6lG9-gateway.appmiaoda.com/tasks";
...
const ENDPOINT = "https://app-dqs7nnc9k54x-api-baBwmdOB6lG9-gateway.appmiaoda.com/tasks";
