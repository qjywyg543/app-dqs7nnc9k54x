...
| API ID | `api-rY7JzDpZVBQL`                                                  |
| Endpoint | `POST http://app-dqs7nnc9k54x-api-rY7JzDpZVBQL-gateway.appmiaoda.com/v1/images/edits` |
...
async function editImage(params: EditImageParams): Promise<EditImageResult> {
  ...
  const response = await fetch(
    "http://app-dqs7nnc9k54x-api-rY7JzDpZVBQL-gateway.appmiaoda.com/v1/images/edits",
    {
      method: "POST",
      headers: {
