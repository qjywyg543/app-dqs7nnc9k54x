...
| API ID | `api-Aa2P8AGZg2RL`                                                        |
| Endpoint | `POST http://app-dqs7nnc9k54x-api-Aa2P8AGZg2RL-gateway.appmiaoda.com/v1/images/generations` |
...
async function createImage(params: CreateImageParams): Promise<CreateImageResult> {
  const response = await fetch(
    "http://app-dqs7nnc9k54x-api-Aa2P8AGZg2RL-gateway.appmiaoda.com/v1/images/generations",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
