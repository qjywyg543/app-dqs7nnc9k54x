...
- **Endpoint**：`GET https://app-dqs7nnc9k54x-api-79jK62Ze2pQL-gateway.appmiaoda.com/location/ip`
...
```bash
python3 scripts/call_ip_geolocation.py --ip 1.2.3.4 --coor bd09ll
python3 scripts/call_ip_geolocation.py
```
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = `https://app-dqs7nnc9k54x-api-79jK62Ze2pQL-gateway.appmiaoda.com/location/ip${
