...
| 属性 | 值 |
|---|---|
| 创建任务 | `POST https://app-dqs7nnc9k54x-api-n9QVBZkleO2L-gateway.appmiaoda.com/motion-control/kling-3.0` |
| 精确查询 | `GET https://app-dqs7nnc9k54x-api-Aa2P8o0BV1RL-gateway.appmiaoda.com/tasks` |
