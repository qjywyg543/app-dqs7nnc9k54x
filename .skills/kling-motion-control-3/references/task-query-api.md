...
```http
GET https://app-dqs7nnc9k54x-api-Aa2P8o0BV1RL-gateway.appmiaoda.com/tasks?task_ids=TASK_ID
GET https://app-dqs7nnc9k54x-api-Aa2P8o0BV1RL-gateway.appmiaoda.com/tasks?external_task_ids=EXTERNAL_ID
```
