...
| Endpoint | `POST https://app-dqs7nnc9k54x-api-baBw3XMNVmv9-gateway.appmiaoda.com/image2`       |
...
async function editImage(params: EditImageParams): Promise<EditImageResult> {
  ...
  const response = await fetch(
    "https://app-dqs7nnc9k54x-api-baBw3XMNVmv9-gateway.appmiaoda.com/image2",
    {
      method: "POST",
      headers: {
