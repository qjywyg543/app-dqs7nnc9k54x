...
生成期调用必须使用 `scripts/call_face_comparison.py`，传入两张本地图片路径或 FACE_TOKEN；脚本内部读取 `INTEGRATIONS_API_KEY`、完成 base64/json 请求，并输出单行 JSON。

示例：`python3 scripts/call_face_comparison.py --image1 /path/to/a.jpg --image2 /path/to/b.jpg`
