...
ENDPOINT = "https://app-dqs7nnc9k54x-api-Aa2PZ2MejdoL-gateway.appmiaoda.com/enterprise/hire-overview"
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Query company hiring overview.")
    parser.add_argument(
