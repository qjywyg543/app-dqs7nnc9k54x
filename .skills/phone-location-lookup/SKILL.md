...
- **Endpoint**：`POST https://app-dqs7nnc9k54x-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area`
...
```bash
python3 <skill-path>/scripts/call_phone_location.py --mobile-number 13800138000
```
...
```json
{"status": "succeed", "result": {"area": "江苏-南通", "originalIsp": "电信", "isVirtuallyIsp": 1}}
```
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = new URL("https://app-dqs7nnc9k54x-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area");
