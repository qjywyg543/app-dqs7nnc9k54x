#!/usr/bin/env python3
"""
Call Baidu bus-ticket OCR and print the structured recognition result.
Base64 data never enters the LLM context.

Usage:
    # Local image file
    python3 call_bus_ticket_ocr.py --image /path/to/ticket.jpg

    # Remote image URL
    python3 call_bus_ticket_ocr.py --url "https://example.com/ticket.jpg"

    # PDF / OFD file
    python3 call_bus_ticket_ocr.py --pdf-file /path/to/doc.pdf [--pdf-file-num 1]
    python3 call_bus_ticket_ocr.py --ofd-file /path/to/doc.ofd [--ofd-file-num 1]
...
ENDPOINT = "https://app-dqs7nnc9k54x-api-Xa6JZxjyqrGa-gateway.appmiaoda.com/rest/2.0/ocr/v1/bus_ticket"
...
def call_api(api_key: str, params: dict) -> dict:
    """Call the bus-ticket OCR endpoint and return the decoded response body."""
